    ...
    json.array!(@event.sessions) do |session|
      ...
      json.tables do
        json.array!(session.tables) do |table|
          ...
          json.scenario do
            json.extract! table.scenario, :type_of, :game_system, :season, :scenario_number, :name, :long_name,
                          :short_name
          end
          ...
          json.game_masters do
            json.array! table.game_masters do |gm|
              json.extract! gm.user_event.user, :name, :pfs_number, :email, :forum_username, :title, :gm_stars,
                            :show_stars
            end
          end
        end
