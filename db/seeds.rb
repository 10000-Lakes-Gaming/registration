...
user_event = UserEvent.create!({ event:, user:, online: true, in_person: true, tee_shirt_size: 'XL' })

RegistrationTable.create!([{ user_event:, table_id: 1, paid: true, payment_amount: 1000,
                             payment_id: 'PAYMENTID' }])
GameMaster.create!({ user_event:, table_id: 3 })
